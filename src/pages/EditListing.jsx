...
//Sets userRef to logein user  
  ...
  const onSubmit = async (e) =>{
    ...
    if(geolocationEnabled){
        ...
        // }
        alert("Add your credentials to make these Work")
    ...
    <main>
        <form onSubmit={onSubmit}>
            ...
            <div className="formButtons">
                ...
                <button className={parking || parking === null ? 'formButton' : 'formButtonActive'} type='button' id='parking' value={false} onClick={onMutate} >No</button>
            </div>
            ...
            <div className="formButtons">
                ...
                <button className={furnished || furnished === null ? 'formButton' : 'formButtonActive'} type='button' id='furnished' value={false} onClick={onMutate} >No</button>
            </div>

            <label className="formLabel">Address</label>
            <textarea type="text" className="formInputAddress" value={address} id="address" onChange={onMutate} required ></textarea>
            ...
            {offer && (
                ...
                <input type="number" className="formInputSmall" id='discountedPrice' value={discountedPrice} onChange={onMutate} min='50' max='750000000' required />
                </>
            )}
